            ...
            <Card className="shadow text-center" style={{minHeight: "660px", borderRadius: 15}}>
              ...
              <h6 className="mb-5 mt-3" style={{color: "#4176FF"}}>Teamspace</h6>
                ...
                <div className="sidebar-sticky"></div>
                  ...
                  <Nav.Item>
                    <Nav.Link href="/settings" className="rounded" style={{marginTop: "5px", marginBottom: "5px", backgroundColor: "#eef2fd", color: "black", padding: 3}}><FontAwesomeIcon icon={faCog}/> Settings</Nav.Link>
                  </Nav.Item>
                    <Nav.Item>
                  </Nav.Item>
                </Nav>
